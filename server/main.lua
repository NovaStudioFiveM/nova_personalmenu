...
do
    ...
    --[[
        ...
        This means you probably have resources which are using `nova_personalmenu` old network event names prefix.
        Please update the event names prefix from `KorioZ-PersonalMenu` to `nova_personalmenu`.
    ]]

    RegisterServerEvent = function(eventName, ...)
        local endIdx = ('nova_personalmenu:'):len()

        if eventName:sub(1, endIdx) == 'nova_personalmenu' then
...
ESX.RegisterServerCallback('nova_personalmenu:Bill_getBills', function(source, cb)
...
ESX.RegisterServerCallback('nova_personalmenu:Admin_getUsergroup', function(source, cb)
...
-- Weapon Menu --
RegisterServerEvent('nova_personalmenu:Weapon_addAmmoToPedS', makeTargetedEventFunction(function(targetServerId, value, quantity)
    if #(GetEntityCoords(GetPlayerPed(source), false) - GetEntityCoords(GetPlayerPed(targetServerId), false)) > 3.0 then return end
    TriggerClientEvent('nova_personalmenu:Weapon_addAmmoToPedC', targetServerId, value, quantity)
end))

-- Admin Menu --
RegisterServerEvent('nova_personalmenu:Admin_BringS', makeTargetedEventFunction(function(playerId, targetServerId)
    local xPlayer = ESX.GetPlayerFromId(source)
    ...
    TriggerClientEvent('nova_personalmenu:Admin_BringC', playerId, GetEntityCoords(GetPlayerPed(targetServerId)))
end))

RegisterServerEvent('nova_personalmenu:Admin_giveCash', function(amount)
    local xPlayer = ESX.GetPlayerFromId(source)
    local plyGroup = xPlayer.getGroup()
...
RegisterServerEvent('nova_personalmenu:Admin_giveBank', function(amount)
    local xPlayer = ESX.GetPlayerFromId(source)
    local plyGroup = xPlayer.getGroup()
...
RegisterServerEvent('nova_personalmenu:Admin_giveDirtyMoney', function(amount)
    local xPlayer = ESX.GetPlayerFromId(source)
    local plyGroup = xPlayer.getGroup()
...
-- Grade Menu --
RegisterServerEvent('nova_personalmenu:Boss_promouvoirplayer', makeTargetedEventFunction(function(targetServerId)
...
RegisterServerEvent('nova_personalmenu:Boss_destituerplayer', makeTargetedEventFunction(function(targetServerId)
    local sourceXPlayer = ESX.GetPlayerFromId(source)
    local sourceJob = sourceXPlayer.getJob()
...
RegisterServerEvent('nova_personalmenu:Boss_recruterplayer', makeTargetedEventFunction(function(targetServerId)
    local sourceXPlayer = ESX.GetPlayerFromId(source)
    local sourceJob = sourceXPlayer.getJob()
...
RegisterServerEvent('nova_personalmenu:Boss_virerplayer', makeTargetedEventFunction(function(targetServerId)
    local sourceXPlayer = ESX.GetPlayerFromId(source)
    local sourceJob = sourceXPlayer.getJob()
...
RegisterServerEvent('nova_personalmenu:Boss_promouvoirplayer2', makeTargetedEventFunction(function(targetServerId)
    local sourceXPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('nova_personalmenu:Boss_destituerplayer2', makeTargetedEventFunction(function(targetServerId)
    local sourceXPlayer = ESX.GetPlayerFromId(source)
    local sourceJob = sourceXPlayer.getJob2()
...
RegisterServerEvent('nova_personalmenu:Boss_recruterplayer2', makeTargetedEventFunction(function(targetServerId, grade2)
    local sourceXPlayer = ESX.GetPlayerFromId(source)
    local sourceJob = sourceXPlayer.getJob2()
...
RegisterServerEvent('nova_personalmenu:Boss_virerplayer2', makeTargetedEventFunction(function(targetServerId)
    local sourceXPlayer = ESX.GetPlayerFromId(source)
    local sourceJob = sourceXPlayer.getJob2()
