...
Config.AdminCommands = {
    {
        ...
        command = function()
            ...
            TriggerServerEvent('nova_personalmenu:Admin_BringS', GetPlayerServerId(PlayerId()), targetServerId)
            RageUI.CloseAll()
        end
    },
    {
        ...
        command = function()
            ...
            TriggerServerEvent('nova_personalmenu:Admin_BringS', targetServerId, GetPlayerServerId(PlayerId()))
            RageUI.CloseAll()
        end
    },
    {
    ...
    },
    {
        ...
        command = function()
            ...
            TriggerServerEvent('nova_personalmenu:Admin_giveCash', amount)
            RageUI.CloseAll()
        end
    },
    {
        ...
        command = function()
            ...
            TriggerServerEvent('nova_personalmenu:Admin_giveBank', amount)
            RageUI.CloseAll()
        end
    },
    {
        ...
        command = function()
            ...
            TriggerServerEvent('nova_personalmenu:Admin_giveDirtyMoney', amount)
            RageUI.CloseAll()
        end
    },
    {
